...
class ChatMinds(BaseChatModel):
    ...
    Key init args — client params:
        ...
        api_key: Optional[str]
            Minds API key. If not passed in will be read from env var MINDS_API_KEY.
    ...
    Tool calling:
        ...
        See ``ChatMinds.bind_tools()`` method for more.
    ...
    Structured output:
        ...
        See ``ChatMinds.with_structured_output()`` for more.
    ...
    # TODO: Implement if ChatMinds supports async streaming. Otherwise delete.
    # async def _astream(
    #     self,
    #     messages: List[BaseMessage],
    #     stop: Optional[List[str]] = None,
    ...
    # TODO: Implement if ChatMinds supports async generation. Otherwise delete.
